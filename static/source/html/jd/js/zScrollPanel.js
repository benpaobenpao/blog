    ...
    var ScrollPanel = function () {
        ...
        function ScrollPanel( page, arg ) {
            ...
            function setTop( targetTop ) {
                ...
                curTop = targetTop;
                var pos = move( content, targetTop );
                setScrollBarPos();
                ...
                if ( targetTop > 0 ) {
                    pos = move( topBlank, targetTop - scrollSize );
                }
                if ( targetTop < bottom ) {
                    pos = move( bottomBlank, targetTop + contentSize );
                }
                return pos;
            }
