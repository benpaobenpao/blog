...
function(e) {
    ...
    function s(e, t, a, o) {
        ...
        L = {},
        M = "",
        k = w; k != x; k = k.parent) k.cN && (M = p(k.cN, "", !0) + M);
        var y = "",
        B = 0;
        try {
            for (var C, j, I = 0;;) {
    ...
    function g(e, n, t) {
        var r = n ? x[n] : t,
        a = [e.trim()];
        return e.match(/(\s|^)hljs(\s|$)/) || a.push("hljs"),
        r && a.push(r),
        a.join(" ").trim()
    }
    function p(e) {
...
hljs.registerLanguage("lang-java",
function(e) {
    var a = e.UIR + "(<" + e.UIR + ">)?",
...
hljs.registerLanguage("lang-html",
function() {
    var t = "[A-Za-z0-9\\._:-]+",
    e = {
        b: /<\?(php)?(?!\w)/,
...
hljs.registerLanguage("lang-cpp",
function(t) {
    var i = {
...
hljs.registerLanguage("lang-php",
function(e) {
    var c = {
        cN: "variable",
